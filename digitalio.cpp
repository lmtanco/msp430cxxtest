...
device_register8& port1_traits::PxSEL2{*reinterpret_cast<device_register8*>(0x041)};

// Definición de la dirección donde está mapeado P2SEL2 (0x042)
device_register8& port2_traits::PxSEL2{*reinterpret_cast<device_register8*>(0x042)};
